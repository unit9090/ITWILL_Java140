...
public class MapMain03 {
    ...
    public static void main(String[] args) {
        ...
        for(String s : sentences) {
        	if(wordCounting.get(s) == null) {
        		wordCounting.put(s, 1);
        	} else {
        		wordCounting.put(s, wordCounting.get(s) + 1);
        	}
        }
        ...
        for(String w : words) {
        	// getOrDefault는 null을 return 할 수 없게 0을 넣어주었기에 int도 사용 가능하다.
