...
public class ListMain03 {
	...
	public static void main(String[] args) {
		...
		List<String> subjects = Arrays.asList("Java", "SQL", "HTML", "CSS", "JavaScript",
...
//		}
		...
		List<Integer> wordLengths = new LinkedList<>();
		for(String x : subjects) {
			wordLengths.add(x.length());
		}
