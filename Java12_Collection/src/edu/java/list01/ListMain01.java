...
/*
 *  리스트(List)의 특징:
 *  1. 한 가지 타입의 값들을 여러 개 저장할 수 있는 데이터 구조체.
 *  2. 값들을 저장하는 순서가 중요 - index를 가지고 있음.
 *  3. 값들을 저장할 때마다 인덱스는 자동으로 증가.	- 배열과는 다르게 저장 용량이 자동으로 증가.
 *  4. 중간에 있는 값을 삭제하면 인덱스는 자동으로 재배열 됨.
...
public class ListMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(languages);	// toString() 메서드가 override 되어 있다.
