...
//		System.out.println(score1);
		...
		System.out.println("score1 score2 equals? " + score1.equals(score2));
		scores.add(score2);
		Score score3 = new Score(100, 100, 100);
		System.out.println("score1 score3 equals? " + score1.equals(score3));
		scores.add(score3);
		...
		// equals가 true이면 hash값이 같다.
		// hash값이 다르면 equals가 false이다.
		// HashSet은 equals가 아니라 hash값을 먼저 호출하여 판단하기 때문에
		// equals를 override를 해도 hashSet을 override 하지 않으면 제대로 동작하지 않는다.
