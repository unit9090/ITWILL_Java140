...
public class DateMain {
	...
	public static void main(String[] args) {
		...
		// Timestamp: 1870-01-01 00:00:00를 기준으로 1/1000초(1 milli-second)마다
		//			  1씩 증가하는 정수를 기반으로 날짜와 시간 정보를 저장하는 클래스.
		// LocalDateTime 객체를 Timestamp 타입 객체로 변환: Timestamp.valueOf(timestamp);
		Timestamp ts = Timestamp.valueOf(now2);	// java.sql => 쿼리
