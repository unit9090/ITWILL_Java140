...
//	3. generic 클래스를 사용하기 위해서.	=> 다음주에 추가 설명.
...
//		new Integer => method나 class에 사선 표시(deprecated)는 사용을 권장하지 않는다는 뜻이다.
		...
		// BigDecimal: 실수 타입의 오차를 원하는 수준까지 작게 줄여서 계산에 사용할 수 있는 클래스.
		// BigDecimal은 wrapper 클래스가 아니기 때문에 auto-unboxing이 안된다.
