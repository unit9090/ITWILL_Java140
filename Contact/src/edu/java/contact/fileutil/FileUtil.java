...
public class FileUtil {
	...
	// -> .\data\contacts.dat 파일에 연락처 리스트를 저장하기 위해셔ㅓ.
	...
	/**
	 * writeDataToFile
	 * argument로 전달된 data를 (직렬화해서) file에 씀. => ObjectOutputStream
	 * 
	 * @param data 파일에 쓸 데이터. Contact 타입을 저장하는 리스트(List<Contact>).
	 * @param file 데이터 파일 객체
	 */
	public static void writeDataToFile(List<Contact> contacts, File file) {
